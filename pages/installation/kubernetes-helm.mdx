...
## The Helm Chart
Publica has a helm chart that is in very active development. You can find it here;
...
https://github.com/Padilla-core/publica-helmchart

The `values.yml` file can be found in the repository, or a direct link to it is: https://github.com/Padilla-core/publica-helmchart/blob/main/charts/publica/values.yaml
