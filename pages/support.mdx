...
Note that the Self Hosted version of Publica is supported by the community in their
...
- [GitHub issue](https://github.com/Padilla-core/publica-app/issues/new/choose) - backup option if you are unable to use Discord.
