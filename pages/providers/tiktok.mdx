...
TikTok will also not allow http:// for your app redirect URI, so you will need to be accessing Publica from HTTPS.
</Callout>
...
### Add a TikTok channel in the Publica web interface

Go to the Publica web interface, and click on the "Add Channel" button. Select "TikTok" from the list of available channels. You should be redirected to TikTok to authorize the application.
